    ...
    <>
      ...
      <div style={{ display: 'flex', flex: 1, minHeight: 0, overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, overflow: 'hidden' }}>
          {/* List header */}
          <div style={{
            display: 'grid', gridTemplateColumns: '86px 1fr 90px',
            padding: '7px 18px', background: 'var(--white)', borderBottom: '0.5px solid var(--border)',
            fontSize: 11, color: 'var(--text3)', fontWeight: 500, letterSpacing: '.04em', textTransform: 'uppercase', flexShrink: 0,
          }}>
            <div>Frist</div>
          ...
          {/* Status bar */}
          <div style={{
            display: 'flex', alignItems: 'center', gap: 10, padding: '5px 18px',
            ...
            <div style={{ marginLeft: 'auto', display: 'flex', gap: 3 }}>
              <button
                ...
                style={{ width: 28, height: 28, borderRadius: 6, border: '0.5px solid var(--border)', background: 'var(--white)', color: 'var(--text2)', fontSize: 11, cursor: 'pointer', opacity: (filters.page || 1) <= 1 ? 0.4 : 1 }}
              >‹</button>
              <button
                onClick={() => setFilters({ ...filters, page: (filters.page || 1) + 1 })}
                disabled={!data?.has_more}
                style={{ width: 28, height: 28, borderRadius: 6, border: '0.5px solid var(--border)', background: 'var(--white)', color: 'var(--text2)', fontSize: 11, cursor: 'pointer', opacity: !data?.has_more ? 0.4 : 1 }}
              >›</button>
            </div>
            ...
            <a
              ...
              style={{
                padding: '4px 10px', borderRadius: 'var(--r)', border: '0.5px solid var(--border)',
                background: 'var(--white)', color: 'var(--text2)', fontSize: 11, textDecoration: 'none',
              }}
            >↓ CSV</a>
          </div>
        </div>
